...
class NPQP_PayPal_API{
    ...
    public function getAccessToken(){
        $response = wp_remote_request( "https://api.sandbox.paypal.com/v1/oauth2/token", [
            'headers' => [
    ...
    public function createDraftInvoice($data){
        ...
        $result = $this->client('post', 'https://api.sandbox.paypal.com/v2/invoicing/invoices', $data);
    ...
    public function verifyWebhook(){
        ...
        $result = $this->client( 'post', 'https://api.sandbox.paypal.com/v1/notifications/verify-webhook-signature', json_encode($data) );
